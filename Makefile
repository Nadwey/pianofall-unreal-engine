...
UNREALROOTPATH = /run/media/nadwey/c6132e9a-b770-488a-8084-161b02047c5e/UnrealEngine-release
GAMEPROJECTFILE =/run/media/nadwey/Szybki Dysk SSD/pianofall-unreal-engine/PianofallUE.uproject
...
TARGETS = \
	...
	DatasmithSketchUpRuby2023-Linux-Debug  \
	DatasmithSketchUpRuby2023-Linux-DebugGame  \
	DatasmithSketchUpRuby2023-Linux-Test  \
	DatasmithSketchUpRuby2023-Linux-Shipping  \
	...
	UnrealServer \
	PianofallUE-Linux-Debug  \
	PianofallUE-Linux-DebugGame  \
	PianofallUE-Linux-Test  \
	PianofallUE-Linux-Shipping  \
	PianofallUE \
	PianofallUEEditor-Linux-Debug  \
	PianofallUEEditor-Linux-DebugGame  \
	PianofallUEEditor-Linux-Test  \
	PianofallUEEditor-Linux-Shipping  \
	PianofallUEEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend PianofallUEEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug PianofallUEEditor-Linux-Debug
...
DatasmithSketchUpRuby2023-Linux-Debug:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Debug  $(ARGS)

DatasmithSketchUpRuby2023-Linux-DebugGame:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux DebugGame  $(ARGS)

DatasmithSketchUpRuby2023-Linux-Test:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Test  $(ARGS)

DatasmithSketchUpRuby2023-Linux-Shipping:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Shipping  $(ARGS)

DatasmithSketchUpRuby2023:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Development  $(ARGS)
...
PianofallUE-Linux-Debug:
	 $(PROJECTBUILD) PianofallUE Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUE-Linux-DebugGame:
	 $(PROJECTBUILD) PianofallUE Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUE-Linux-Test:
	 $(PROJECTBUILD) PianofallUE Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUE-Linux-Shipping:
	 $(PROJECTBUILD) PianofallUE Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUE:
	 $(PROJECTBUILD) PianofallUE Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUEEditor-Linux-Debug:
	 $(PROJECTBUILD) PianofallUEEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUEEditor-Linux-DebugGame:
	 $(PROJECTBUILD) PianofallUEEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUEEditor-Linux-Test:
	 $(PROJECTBUILD) PianofallUEEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUEEditor-Linux-Shipping:
	 $(PROJECTBUILD) PianofallUEEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

PianofallUEEditor:
	 $(PROJECTBUILD) PianofallUEEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
